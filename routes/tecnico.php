...
Route::middleware(['auth', 'role:tecnico'])
    ...
    ->group(function () {
        ...
        Route::get('/cortes/export/pdf', [TecnicoController::class, 'exportCortesPdf'])->name('cortes.export.pdf');
        Route::get('/cortes/export/csv', [TecnicoController::class, 'exportCortesCsv'])->name('cortes.export.csv');
