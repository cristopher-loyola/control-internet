<x-app-sidebar>
    ...
    <div class="min-h-screen bg-gray-100 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        @if(isset($corteActivo) && $corteActivo)
                            <div class="mt-2 p-2 bg-green-100 rounded-md inline-flex items-center gap-3">
                                <span class="text-sm text-green-800">
                                    <span class="font-semibold">Corte activo:</span> {{ \Carbon\Carbon::parse($corteActivo->fecha_inicio)->format('d/m/Y H:i') }}
                                </span>
                                <a href="{{ route('chivato.corte.exportar') }}"
                                   class="inline-flex items-center px-3 py-1.5 bg-green-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-800 focus:bg-green-800 active:bg-green-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150 shadow-sm">
            ...
            <!-- Filtro de Fechas -->
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <form method="GET" action="{{ route('chivato.corte') }}" class="flex flex-wrap items-end gap-4">
