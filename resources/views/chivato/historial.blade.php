<x-app-sidebar>
    <x-slot name="headerTitle">Historial de Pagos - Chivato</x-slot>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Lista de todos los pagos registrados en el perfil Chivato</p>
                    </div>
                        ...
                        <tbody>
                            @forelse($pagos as $pago)
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3">
                                        @if(!$pago['cancelado'])
                                            <form id="delete-form-{{ $pago['id'] }}" method="POST" action="{{ route('chivato.pagos.eliminar', $pago['id']) }}" class="inline">
                                                @csrf
                                                @method('DELETE')
