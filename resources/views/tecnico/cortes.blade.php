        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                    <form action="{{ route('tecnico.cortes.index') }}" method="GET" class="w-full md:w-1/2 flex gap-2">
                ...
                <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            ...
                            <tr class="{{ $u->pagado_mes ? 'bg-green-100 dark:bg-green-900/40 text-green-900 dark:text-green-100' : '' }} transition-colors">
        ...
        function cortesManager() {
            return {
                ...
                async removeCortador(id) {
                    ...
                    try {
                        const token = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
                        const r = await fetch(`{{ url('/tecnico/cortes/cortadores') }}/${id}`, {
                            method: 'DELETE',
                            headers: {
                                'X-CSRF-TOKEN': token
                            }
