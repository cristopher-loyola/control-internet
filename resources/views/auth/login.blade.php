            ...
            <div class="relative z-10 text-center px-4">
                @if ($logoUrl)
                    <div class="mb-6 flex justify-center">
                        <img src="{{ asset($logoUrl) }}" alt="Control Internet" class="max-w-[220px] md:max-w-[260px] w-full h-auto drop-shadow-2xl">
                    </div>
                @else
                    {{-- Ícono placeholder si no hay logo --}}
                    <div class="mb-6 flex justify-center">
                        <div class="w-16 h-16 rounded-2xl bg-red-600/30 border border-red-500/40 flex items-center justify-center">
