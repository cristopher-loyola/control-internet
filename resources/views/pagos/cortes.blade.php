            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('pagos.cortes.export.csv') }}?{{ http_build_query(request()->only(['q', 'zona', 'estado'])) }}" class="btn btn-success flex items-center gap-2" title="Exportar a Excel los usuarios por cortar">
                            📊 Excel
                        </a>
