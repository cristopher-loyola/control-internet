<x-app-layout title="Dashboard">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded shadow p-4">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('pagos.dashboard.desactivados') }}" class="btn btn-primary">Ver todos</a>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded shadow p-4 mt-4">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('pagos.dashboard.morosos') }}" class="btn btn-primary">Ver todos</a>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-5 flex flex-col gap-4">
                <div class="flex items-center justify-between border-b border-gray-100 dark:border-gray-700 pb-3">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('pagos.dashboard.prepay.index') }}" class="btn btn-primary btn-sm">Ver todos</a>
                    </div>
                </div>
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm">
    ...
    function pagosDashboard(){
        return {
            ...
            exportar(fmt){
                const url = new URL('{{ route('pagos.dashboard.export') }}', window.location.origin);
            ...
            loadMetrics(showLoader = true){
                ...
                const url = new URL('{{ route('pagos.dashboard.metrics') }}', window.location.origin);
                url.searchParams.set('period', this.period);
                if(this.period==='day'){
                    url.searchParams.set('date', this.dayDate);
                } else if(this.period==='week'){
