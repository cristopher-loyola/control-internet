<x-app-layout title="Historial de Pagos - Perfil Chivato">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">
            Historial de Pagos - Perfil Chivato
        </h2>
    </x-slot>
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white">
                            Pagos realizados por Perfil Chivato
                        </h3>
                    ...
                    <div class="mb-6 bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                        <form method="GET" action="{{ route('admin.pagos.chivato.history') }}">
                            <div class="flex flex-col md:flex-row gap-4 items-end">
                                ...
                                <div class="flex gap-2 mt-6 md:mt-0">
                                    ...
                                    @if(request('folio') || request('servicio'))
                                        <a href="{{ route('admin.pagos.chivato.history') }}" class="px-6 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 whitespace-nowrap">
                                            Limpiar
                                        </a>
                                    @endif
                                </div>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                            No se encontraron pagos realizados por Perfil Chivato
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
