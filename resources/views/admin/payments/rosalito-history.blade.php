<x-app-layout title="Historial de Pagos - Rosalito">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">
            Historial de Pagos - Rosalito
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mb-6 bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                        <form method="GET" action="{{ route('admin.pagos.rosalito.history') }}">
                            <div class="flex flex-col md:flex-row gap-4 items-end">
                                ...
                                <div class="flex gap-2 mt-6 md:mt-0">
                                    ...
                                    @if(request('folio') || request('servicio'))
                                        <a href="{{ route('admin.pagos.rosalito.history') }}" class="px-6 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 whitespace-nowrap">
                                            Limpiar
                                        </a>
                                    @endif
                                </div>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                            No se encontraron pagos realizados por Rosalito
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
