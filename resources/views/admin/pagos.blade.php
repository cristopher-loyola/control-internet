<x-app-layout title="Pagos">
    ...
    <div class="flex items-center justify-between mb-1">
        ...
        <a href="{{ route('profile.edit') }}#cobradores"
...
<div x-show="adeudo && adeudo.pendiente>0" class="mt-4 mb-4 p-4 bg-red-50 border border-red-200 rounded-lg not-print">
...
<div x-show="(!adeudo || adeudo.pendiente <= 0) && (pagadoMesActual || alCorriente || (adeudo !== null && adeudo.meses <= 0 && adeudo.pendiente <= 0))" class="mt-4 mb-4 p-4 bg-green-50 border border-green-200 rounded-lg not-print">
    <div class="flex items-center gap-2 mb-2">
                    ...
                    <div class="mt-6 print-sheet" x-ref="sheet" x-show="layoutReady" x-cloak>
                        ...
                        <div class="receipt">
                            ...
                            <div class="receipt-grid">
                                <div x-show="(!adeudo || adeudo.pendiente <= 0) && (pagadoMesActual || alCorriente || (adeudo !== null && adeudo.meses <= 0 && adeudo.pendiente <= 0))">Estatus</div><div x-show="(!adeudo || adeudo.pendiente <= 0) && (pagadoMesActual || alCorriente || (adeudo !== null && adeudo.meses <= 0 && adeudo.pendiente <= 0))">Pagado</div>
                        ...
                        <div class="card-body p-3 overflow-y-auto" style="max-height: calc(100vh - 420px);">
                            ...
                            <template x-for="m in paginatedMorosos" :key="m.numero">
                                <div class="relative flex items-center gap-2 bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700 hover:border-red-200 hover:shadow-md transition-all duration-200 overflow-hidden mb-1.5">
                                    ...
                                    <!-- Botón principal (ocupa casi todo el ancho) -->
            ...
            async init(){
                ...
                try{
                    ...
                    if(numeroUrl && !this.form.numero){
                        ...
                        await this.buscar();
                        if(Number(params.get('monto_transferencia') || 0) > 0){
                            this.form.metodo = 'Deposito a cuenta';
                        }
                        const periodoTransf = params.get('periodo_transferencia');
                        if(periodoTransf){
                            this.periodoOverride = periodoTransf;
...
<body>${sheet ? sheet.outerHTML : ''}</body>
            ...
            async fetchPagoAnterior(){
                ...
                try{
                    let url = '{{ route('admin.pagos.prev') }}?numero='+encodeURIComponent(this.form.numero);
                    if (this.ref && this.ref.id) {
