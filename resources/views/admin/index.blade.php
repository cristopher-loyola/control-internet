<x-app-layout title="Dashboard">
    ...
    function adminDashboard(){
        return {
            ...
            monthVal: null,
            validWeek: true,
            metrics: { metodos: [], clientes_nuevos: {day:0,week:0,month:0}, inventario_bajo: [], ventas_series: {labels:[], values:[]}, prepay_clients: [], cancelados_count: 0, cancelados: [], morosos: [], morosos_count: 0 },
            chartMetodos: null,
            chartClientes: null,
