            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-4 flex items-center justify-between">
                        ...
                        <form method="GET" action="{{ route('admin.clientes.historial.buscar') }}" class="flex items-center gap-2">
                            <input
                                type="text"
                                name="q"
                                value="{{ $q }}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-2 whitespace-nowrap text-sm">
                                                @if(!is_null($u->numero_servicio))
                                                    <a href="{{ route('admin.clientes.historial', $u->numero_servicio) }}" class="btn btn-info btn-sm">Ver historial</a>
                                                @else
                                                    —
                                                @endif
                                            </td>
