...
<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-5 flex flex-col gap-4">
    <div class="flex items-center justify-between">
        ...
        <div class="w-9 h-9 rounded-full flex items-center justify-center" style="background:rgba(139,92,246,0.12);">
    ...
    <div class="flex flex-col gap-4">
        <div class="text-center">
            <div class="text-3xl font-bold text-gray-800 dark:text-white" x-text="money(metrics.pozo_hondo_pagos ?? 0)"></div>
