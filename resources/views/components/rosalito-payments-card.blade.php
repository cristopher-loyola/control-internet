    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="grid grid-cols-2 gap-4 text-center">
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                <div class="text-xl font-bold text-gray-800 dark:text-white" x-text="metrics.rosalito_count ?? 0"></div>
                <div class="text-xs text-gray-500">Pagos</div>
            </div>
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                <div class="text-xl font-bold text-gray-800 dark:text-white" x-text="money(metrics.rosalito_promedio ?? 0)"></div>
