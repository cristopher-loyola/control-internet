                                ...
                                @forelse ($historial as $h)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 whitespace-nowrap text-sm">
                                            <span class="inline-flex items-center px-2 py-1 rounded text-xs {{ $h->accion === 'delete' ? 'bg-rose-600 text-white' : ($h->accion === 'update' ? 'bg-amber-500 text-white' : 'bg-emerald-600 text-white') }}">
                                                {{ strtoupper($h->accion) }}
                                            </span>
                                        </td>
