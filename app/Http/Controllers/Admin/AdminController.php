...
class AdminController extends Controller
{
    ...
    public function pagosHistorial(Request $request)
    {
        ...
        $rows = $paginator->getCollection()->map(function ($f) use ($users, $reasons) {
            ...
            $totalModificado = !empty($payload['manual_total_enabled']);
            ...
            return (object) [
                ...
                'adeudo_modificado' => $totalModificado,
                'motivo_modificacion' => $totalModificado ? ($payload['manual_total_reason'] ?? null) : null,
            ];
        });
    ...
    public function clientesStore(Request $request)
    {
        ...
        Usuario::create([
            ...
            // Mes en que le toca su primer pago. Si no se indica, se asume el
            // mes siguiente al alta (comportamiento de siempre).
